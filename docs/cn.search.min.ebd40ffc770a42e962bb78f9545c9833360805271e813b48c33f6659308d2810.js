...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/yan-tutorial/flexsearch.min.js');loadScript('/yan-tutorial/cn.search-data.min.447936eb8d50fe4fb8c8818fe977b6406f57a713eb483e856c9a93a7e857bec9.js',function(){input.required=false;search();});}
