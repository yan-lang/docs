...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/yan-tutorial/flexsearch.min.js');loadScript('/yan-tutorial/en.search-data.min.8a4724cc9afb209d28b6ed1abb7021c48d10c1e814def5036e3fdf4ebfdf49b0.js',function(){input.required=false;search();});}
