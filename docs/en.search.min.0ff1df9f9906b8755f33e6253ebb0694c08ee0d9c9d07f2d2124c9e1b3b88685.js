...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/yan-tutorial/flexsearch.min.js');loadScript('/yan-tutorial/en.search-data.min.80936466578acd71853eeef4cc0a920253dccc70c2775e6f083b4ddeb5713197.js',function(){input.required=false;search();});}
