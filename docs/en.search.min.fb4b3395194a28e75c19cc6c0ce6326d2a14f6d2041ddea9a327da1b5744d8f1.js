...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/yan-tutorial/flexsearch.min.js');loadScript('/yan-tutorial/en.search-data.min.1788447e4990e5155066bf50d7b2a0801d59fcfcdbaa512d2baf8f51c6bea65b.js',function(){input.required=false;search();});}
