...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/cn.search-data.min.b5adbbaa056a12d86c43d65b6323a0caf88a0a3e1251c0b6fc4d3ce5b9002804.js',function(){input.required=false;search();});}
