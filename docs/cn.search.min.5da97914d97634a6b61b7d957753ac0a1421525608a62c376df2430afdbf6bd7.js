...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/cn.search-data.min.920086bc86f701efeb056bb4db477df3d16b0a5e437102e45635f4af1641693a.js',function(){input.required=false;search();});}
