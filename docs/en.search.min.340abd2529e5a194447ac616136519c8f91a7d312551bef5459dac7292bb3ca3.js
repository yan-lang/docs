...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/yan-tutorial/flexsearch.min.js');loadScript('/yan-tutorial/en.search-data.min.3601f7ab1d410101d910d6cd502e41db233cbf484b7715e1aa5c01736dfb4512.js',function(){input.required=false;search();});}
